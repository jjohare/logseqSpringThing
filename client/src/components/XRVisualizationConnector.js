 ...
 */
const XRVisualizationConnector = () => {
    ...
    return (_jsx(MetadataVisualizer, { renderLabels: settings?.visualization?.labels?.enabled !== false, renderIcons: settings?.visualization?.icons?.enabled !== false, renderMetrics: settings?.visualization?.metrics?.enabled }));
};
