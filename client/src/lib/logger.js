...
export function createLogger(namespace, options = {}) {
    ...
    function createLogMethod(logLevel) {
        return function (message, ...args) {
            ...
            console[logLevel === 'debug' ? 'log' : logLevel](`${prefix} ${formatMessage(message)}`, `color: ${color}; font-weight: bold;`, ...formattedArgs);
        };
    }
    return {
...
export function createErrorMetadata(error) {
...
export function createDataMetadata(data) {
    return {
        ...data,
